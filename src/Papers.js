        ...
        <div>
          ...
          <li>
            <div className="OnePaper">
              ...
              <div>NeurIPS 2018 Deep Reinforcement Learning Workshop. <a href={spu[1]}>PDF</a> <a href="https://drive.google.com/file/d/1Yg8x4bSzoj1t6Sk-_N3jTx2eTaVZGoqW/view?usp=sharing">Slide</a>
            </div>
              <div>{spu[2]}</div>
            </div>
          </li>
