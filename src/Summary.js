  ...
  render() {
    return (
      <div className="Summary">
        ...
        <div className="SummaryOneP">I am a first-year PhD student in the <a href="http://ai.ucsd.edu/">Artificial Intelligence</a> group at the University of California San Diego. My advisor is <a href="http://www.hichristensen.net">Prof. Henrik I. Christensen</a>. I also collaborate with <a href="http://cseweb.ucsd.edu/~haosu/">Prof. Hao Su</a> and <a href="https://scungao.github.io">Prof. Sean Gao</a>. I work on model-based Reinforcement Learning. Right now, I'm investigating how to best learn the dynamics model.</div>
