  ...
  render() {
    return (
      <div className="Summary">
        ...
        <div className="SummaryOneP">I am a PhD student in the <a href="http://ai.ucsd.edu/">Artificial Intelligence</a> group at the University of California San Diego. I'm advised by <a href="http://www.hichristensen.net">Prof. Henrik I. Christensen</a>. I work on model-based Reinforcement Learning. Right now, I'm investigating how to best learn the dynamics model.</div>
